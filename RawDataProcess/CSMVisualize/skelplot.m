# Prototype 3D Plotter for Preliminary Analysis
...
# Primary Single Frame Joint Plot
# Edges: Head Center, Shoulders, Elbows, Wrists, Hips, Knees, Ankles
function csmplot_min(skel, meta)
    # HEAD CENTER
...
#csmplot_min(frame, skel_data.meta);